                        ...
                        <div class="row slide-margin">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    ...
                                    <h2 class="animation animated-item-2">Expliquez-nous brièvement votre demande et nous vous fournirons un devis provisoire.</h2>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="carousel-content">
                            ...
                            <div class="col-sm-10">
                                <div class="carousel-content">
                                     <h3 class="animation animated-item-1">Un devis détaillé vous sera envoyé sur votre adresse email et nous vous mettrons en relation avec un de nos employés afin d'affiner votre demande si nécessaire.</h3>
                                </div>
                            </div>
                        </div>
                    </div>
