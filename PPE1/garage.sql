...
CREATE TABLE IF NOT EXISTS PIECES
 (
   ...
   TYPE_PIECE CHAR(32) NULL  ,
   PRIX_PIECE DECIMAL(10,2) NULL  ,
   TAUXTVA_PIECE CHAR(32) NULL  
...
CREATE TABLE IF NOT EXISTS PARTICULIERS
 (
   ID_CLIENT INTEGER NOT NULL  ,
   CIVILITE_PARTICULIER CHAR(32) NULL  ,
   NOM_PARTICULIER VARCHAR(128) NULL  ,
   PRENOM_PARTICULIER CHAR(32) NULL  ,
   DATENAISS_PARTICULIER DATE NULL  ,
   ADR_CLIENT CHAR(32) NULL  ,
   CP_CLIENT INTEGER NULL  ,
   VILLE_CLIENT CHAR(32) NULL  ,
   MAIL_CLIENT CHAR(32) NULL  ,
   TEL_CLIENT INTEGER NULL  ,
   MDP_CLIENT CHAR(32) NULL  ,
   ETAT_CLIENT CHAR(32) NULL  
...
CREATE TABLE IF NOT EXISTS TECHNICIENS
 (
   ...
   NOM_TECHNICIEN CHAR(255) NULL  ,
   PRENOM_TECHNICIEN CHAR(255) NULL  ,
   ...
   DISPONIBILITE_TECHNICIEN BOOL NULL  
...
CREATE TABLE IF NOT EXISTS ENTREPRISES
 (
   ...
   ACTIVITE_ENTREPRISE CHAR(32) NULL  ,
   ADR_CLIENT CHAR(32) NULL  ,
   CP_CLIENT INTEGER NULL  ,
   VILLE_CLIENT CHAR(32) NULL  ,
   MAIL_CLIENT CHAR(32) NULL  ,
